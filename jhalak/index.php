...
<head>
     ...
     <title>Jhalak | Shabd Production</title>
...
<body>
     ...
     <div class="offcanvas___menu___wrapper">
          ...
          <nav class="offcanvas___menu mobile-menu">
               <ul>
                    ...
                    <li class="active"><a href="./">Jhalak</a></li>
     ...
     <div class="container gallery">
          ...
          <div class="gallery___img">
               <?php
               $q1 = "SELECT * FROM `shabd_gallery`";
               $fireq1 = mysqli_query($link, $q1);

               if (mysqli_num_rows($fireq1) > 0) {
                    while ($q1Data = mysqli_fetch_assoc($fireq1)) {
               ?>
                         <div class="img" id="<?php echo $q1Data['galleryPhotoId']; ?>">
                              <img src="../img/gallery/<?php echo $q1Data['galleryPhoto']; ?>" class="w-100 shadow-1-strong rounded mb-4" alt="<?php echo $q1Data['galleryPhotoTitle']; ?>" />
                         </div>
               <?php
                    }
               }
