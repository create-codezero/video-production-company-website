...
<div class="flex w-100per p-y-50 e-c">
     ...
     <div class="form-box">
          <div class="main-box">
               ...
               <form action="./actions/emailSender.php" class="e-center" method="POST" enctype="multipart/form-data">
                    ...
                    <p class="fs-15 fw-500" style="margin-top: 20px; margin-left: 2px;">Send to Email List</p>
