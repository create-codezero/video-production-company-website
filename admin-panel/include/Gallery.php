...
$_SESSION['adminDPage'] = "Gallery";
?>
<div class="flex e-c p-y-40" style="min-height: 75vh;">
     <div class="form-box">
          <div class="main-box">
               <form class="m-t-20" enctype="multipart/form-data" method="POST" action="./actions/uploadPhoto.php">
                    <p class="fs-20 tx-center">Photo Details</p>

                    <p class="fs-15 fw-500" style="margin-top: 20px; margin-left: 2px;">Photo Title</p>
                    <div class="input">
                         <input type="text" name="photoTitle" id="PhotoTitle" placeholder="Photo Title" title="Please a give title for your video." required>
                    </div>
                    ...
                    <button class="btn btn-gra-purple cursor-pointer" style="margin: 20px auto 10px;" type="submit" name="Upload_Photo">Upload</button>
               </form>
          </div>
     </div>
</div>
