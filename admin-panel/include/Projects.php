...
<div class="flex e-c w-100per flex-d-column" style="min-height: 75vh;">
     <div class="m-y-20">
          <h1 class="fs-40 tx-center font-poppins">Projects</h1>
     </div>
     <div class="flex flex-d-column e-c" style="max-width: 600px; width:95%;">
          ...
          $gettingAllWinningServices = "SELECT * FROM `shabd_projects`";
          ...
          ?>
                    <div class="testimonial-control-card font-poppins e-c bg-clr-4 flex tx-left p-y-30 w-100per m-y-10" style="border-radius: 10px;" id="<?php echo $winningServiceDetails['projectId']; ?>">
                         <div class="flex flex-d-coloumn" style="justify-content:space-between; align-items:center; width:90%;">
                              <div class="flex flex-d-column">
                                   <p class="fs-20 fw-600"><?php echo $winningServiceDetails['projectName']; ?></p>
                                   <p class="fw-400" style="font-size: 13px;">Downloads: <?php echo $winningServiceDetails['totalDownloads']; ?></p>
                                   <p class="m-t-10"><?php echo $winningServiceDetails['projectDescription']; ?></p>
                              </div>

                              <div class="flex flex-d-column cursor-pointer m-10">
                                   <a href="./actions/delete.php?db=projects&id=<?php echo $winningServiceDetails['projectId']; ?>">
