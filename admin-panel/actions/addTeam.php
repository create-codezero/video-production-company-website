...
if (isset($_POST['Add_Team'])) {
     ...
     $photo_folder = "../../img/team/" . $photo_name;
     ...
     $q = " INSERT INTO `shabd_team`(`memberName`, `memberPosition`, `memberDescription`, `memberProfile`, `addedTime`) VALUES ('$name','$position','$description','$photo_name','$dateTime') ";
